                ...
                <v-table>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="ClaimId">{{ val.claimId }}</td>
                            <td class="whitespace-nowrap" label="UserId">{{ val.userId }}</td>
                            <td class="whitespace-nowrap" label="ReviewResult">{{ val.reviewResult }}</td>
        ...
        <v-col>
            ...
            >
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            <Number label="ClaimId" v-model="selectedRow.claimId" :editMode="true"/>
                            <String label="UserId" v-model="selectedRow.userId" :editMode="true"/>
                            <String label="ReviewResult" v-model="selectedRow.reviewResult" :editMode="true"/>
